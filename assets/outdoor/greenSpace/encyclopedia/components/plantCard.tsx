        ...
        <>
            <Card
                ...
                actions={[
                    <SunshineRate
                        disabled={true}
                        value={Number(initialPlant.sunshine)}
                    />,
                    <WateringRate
                        disabled={true}
                        value={Number(initialPlant.watering)}
                    />,
                    <>
                        <FontAwesomeIcon
                            icon={faSnowflake}
                        ...
                        <span style={{verticalAlign: 'text-bottom'}}>
                            {' '}
                            {Number(initialPlant.rusticity)}°C
                        </span>
                    </>,
                ]}
            ...
            >
                <Meta
                    avatar={
                        <Avatar
                            src={
                                initialPlant.foliage === Foliage.PERSISTENT
                                    ? leaf
                                    : autumn
                            }
                        />
