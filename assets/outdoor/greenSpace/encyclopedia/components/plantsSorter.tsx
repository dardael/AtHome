...
const PlantsSorter:React.FunctionComponent<{onSort: Function, plants: Plant[], style}>
    = ({onSort, plants, style}) =>{
    ...
    return <>
        <Button onClick={sortPlants}
                icon={sortType === 'ASC' ? <SortAscendingOutlined /> : <SortDescendingOutlined />}
                size={'large'}
                style={style}
        />
    </>
